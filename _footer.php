  ...
  <nav role="navigation" id="nav" class="navigation" aria-label="Main Navigation">
    ...
    <ul>
      ...
      <li<?php if($active == 'mobile-statistics') echo ' class="nav-active"'; ?>><a href="/mobile-statistics/" accesskey="m"><em>m</em>obile statistics</a></li>
      <li<?php if($active == 'testing-on-mobile') echo ' class="nav-active"'; ?>><a href="/testing-on-mobile/" accesskey="t"><em>t</em>esting on mobile</a></li>
      <li<?php if($active == 'the-lab') echo ' class="nav-active"'; ?>><a href="/the-lab/" accesskey="l">the <em>l</em>ab</a></li>
    </ul>
  </nav>
