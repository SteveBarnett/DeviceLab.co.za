...
<ul>
<li>input methods such as fingers on a touch screen rather (are link targets big enough?);</li>
<li>the weight, size, form factor, and portability of a device (is the text well-sized with the screen up close?);</li>
<li>the quality and condition of the hardware (how well does the site work if the touch screen is not very responsive, is cracked, or dirty?);</li>
<li>capabilities: touch, GPS, accelerometer, etc. (can we use the device&#8217;s extra capabiliites to add extra value for the user?)</li>
</ul>
